...
class IzincutiController extends Controller
{
    public function index(Request $request)
    {
        ...
        $qcuti->join('divisi', 'karyawan.kode_div', '=', 'divisi.kode_div');
        $qcuti->join('unit', 'karyawan.kode_unit', '=', 'unit.kode_unit');
        ...
        if (!empty($request->kode_unit)) {
            $qcuti->where('karyawan.kode_unit', $request->kode_unit);
        }

        if (!empty($request->kode_div)) {
            $qcuti->where('karyawan.kode_div', $request->kode_div);
        }
                ...
                while (strtotime($dari) <= strtotime($sampai)) {
                    ...
                    if ($jamkerja == null) {
                        $jamkerja = Detailsetjamkerjabydiv::join('presensi_jamkerja_bydiv', 'presensi_jamkerja_bydiv_detail.kode_jk_div', '=', 'presensi_jamkerja_bydiv.kode_jk_div')
                            ...
                            ->where('kode_unit', $izincuti->kode_unit)
