...
@section('content')
    ...
    <style>
        ...
        /* Style absolute untuk maps agar menempel di bawah kamera dan di atas listunit */
                                ...
                                <div class="select-wrapper">
                                    <select name="unit" id="unit" class="form-control">
                                        @foreach ($unit as $item)
                                            <option {{ $item->kode_unit == $karyawan->kode_unit ? 'selected' : '' }}
                                                value="{{ $item->lokasi_unit }}">
...
@push('myscript')
    ...
    <script>
        ...
        $(function() {
            ...
            let lokasi_unit = multi_lokasi ? document.getElementById('unit').value :
                "{{ $lokasi_kantor->lokasi_unit }}";
            // Variabel map global
            let map;
            // alert(lokasi_unit);
