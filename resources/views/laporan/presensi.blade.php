            ...
            <div class="card-body">
                <form action="{{ route('laporan.cetakpresensi') }}" method="POST" target="_blank" id="formPresensi">
                    ...
                    <div class="form-group mb-3">
                        <select name="kode_unit" id="kode_unit_presensi" class="form-select select2Kodeunitpresensi">
                    ...
                    <div class="form-group mb-3">
                        <select name="kode_div" id="kode_div_presensi" class="form-select select2Kodedivpresensi">
                            <option value="">Semua Divisi</option>
                            @foreach ($divisi as $d)
                                <option value="{{ $d->kode_div }}">{{ textUpperCase($d->nama_div) }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group mb-3">
...
<script>
    $(function() {
        const select2Kodeunitpresensi = $(".select2Kodeunitpresensi");
        ...
        $("#kode_unit_presensi").change(function() {
