...
class IzinsakitController extends Controller
{
    public function index(Request $request)
    {
        ...
        $qizin->join('divisi', 'karyawan.kode_div', '=', 'divisi.kode_div');
        ...
        if (!empty($request->kode_div)) {
            $qizin->where('karyawan.kode_div', $request->kode_div);
        }
                ...
                while (strtotime($dari) <= strtotime($sampai)) {
                    ...
                    if ($jamkerja == null) {
                        $jamkerja = Detailsetjamkerjabydiv::join('presensi_jamkerja_bydiv', 'presensi_jamkerja_bydiv_detail.kode_jk_div', '=', 'presensi_jamkerja_bydiv.kode_jk_div')
                            ...
                            ->where('kode_unit', $izinsakit->kode_unit)
