...
use App\Http\Controllers\JamkerjabydivController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::controller(DivisiController::class)->group(function () {
        ...
        Route::get('/divisi/create', 'create')->name('divisi.create')->can('divisi.create');
        Route::post('/divisi', 'store')->name('divisi.store')->can('divisi.create');
        Route::get('/divisi/{nik}', 'edit')->name('divisi.edit')->can('divisi.edit');
        Route::put('/divisi/{nik}', 'update')->name('divisi.update')->can('divisi.edit');
        Route::delete('/divisi/{nik}/delete', 'destroy')->name('divisi.delete')->can('divisi.delete');
    });
    ...
    Route::controller(UnitController::class)->group(function () {
        ...
        Route::post('/unit', 'store')->name('unit.store')->can('unit.create');
        Route::get('/unit/{kode_unit}', 'edit')->name('unit.edit')->can('unit.edit');
        Route::put('/unit/{kode_unit}', 'update')->name('unit.update')->can('unit.edit');
    ...
    Route::controller(JamkerjabydivController::class)->group(function () {
        Route::get('/jamkerjabydiv', 'index')->name('jamkerjabydiv.index')->can('jamkerjabydiv.index');
        Route::get('/jamkerjabydiv/create', 'create')->name('jamkerjabydiv.create')->can('jamkerjabydiv.create');
        Route::post('/jamkerjabydiv', 'store')->name('jamkerjabydiv.store')->can('jamkerjabydiv.create');
        Route::get('/jamkerjabydiv/{kode_jk_div}/edit', 'edit')->name('jamkerjabydiv.edit')->can('jamkerjabydiv.edit');
        Route::put('/jamkerjabydiv/{kode_jk_div}', 'update')->name('jamkerjabydiv.update')->can('jamkerjabydiv.edit');
        Route::delete('/jamkerjabydiv/{kode_jk_div}/delete', 'destroy')->name('jamkerjabydiv.delete')->can('jamkerjabydiv.delete');
    });
