...
@push('myscript')
    ...
    <script>
        ...
        $(function() {
            ...
            let lokasi_user;
            let lokasi_unit = "{{ $lokasi_kantor->lokasi_unit }}";
            // Variabel map global
            let map;
            // alert(lokasi_cabang);
            ...
            function successCallback(position) {
                try {
                    ...
                    var radius = "{{ $lokasi_kantor->radius_unit }}";
                        ...
                        error: function(xhr) {
                            ...
                            swal.fire({
                                ...
                                didClose: function() {
                                    ...
                                    $("#absenpulang").prop('disabled', false);
                                    $("#absenmasuk").html(
                                        '<ion-icon name="finger-print-outline" style="font-size: 24px !important"></ion-icon><span style="font-size:14px">Mulai Istirahat</span>'
                                    );
                                }
                        ...
                        error: function(xhr) {
                            ...
                            swal.fire({
                                ...
                                didClose: function() {
                                    ...
                                    $("#absenpulang").prop('disabled', false);
                                    $("#absenpulang").html(
                                        '<ion-icon name="finger-print-outline" style="font-size: 24px !important"></ion-icon><span style="font-size:14px">Selesai Istirahat</span>'
                                    );
                                }
