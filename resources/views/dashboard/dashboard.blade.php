            ...
            <div class="row">
                ...
                <div class="col">
                    <x-select label="Unit" name="kode_unit" :data="$unit" key="kode_unit" textShow="nama_unit"
                        selected="{{ Request('kode_unit') }}" />
                </div>
                <div class="col">
                    <x-select label="Divisi" name="kode_div" :data="$divisi" key="kode_div" textShow="nama_div"
                        selected="{{ Request('kode_div') }}" upperCase="true" />
                </div>
                <div class="col-1">
                    ...
                    <div class="row gy-4 gy-sm-1">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="d-flex justify-content-between align-items-start card-widget-2 border-end pb-4 pb-sm-0">
                                <div>
                                    <p class="mb-1">Karyawan PKWTT</p>
                                    <h4 class="mb-1">{{ $status_karyawan->jml_PKWTT }}</h4>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    <p class="mb-1">Karyawan PKWT</p>
                                    <h4 class="mb-1">{{ $status_karyawan->jml_PKWT }}</h4>
                                </div>
