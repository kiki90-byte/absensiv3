<form action="{{ route('jamkerjabydiv.update', Crypt::encrypt($jamkerjabydiv->kode_jk_div)) }}" method="POST" id="formSetJamkerja">
    @csrf
    @method('PUT')
    <div class="row">
        <div class="col">
            <table class="table">
                <tr>
                    <th>Kode</th>
                    <td>{{ $jamkerjabydiv->kode_jk_div }}</td>
                </tr>
                <tr>
                    <th>Unit</th>
                    <td class="text-uppercase">{{ $jamkerjabydiv->nama_unit }}</td>
                </tr>
                <tr>
                    <th>Divisi</th>
                    <td class="text-uppercase">{{ $jamkerjabydiv->nama_div }}</td>
                </tr>
            </table>
        </div>
    </div>
