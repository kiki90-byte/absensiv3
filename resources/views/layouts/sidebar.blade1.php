 ...
 <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
     ...
     <ul class="menu-inner py-1">
         ...
         @if (auth()->user()->hasAnyPermission(['karyawan.index', 'divisi.index', 'unit.index', 'cuti.index', 'jamkerja.index', 'jabatan.index']))
             <li
                 class="menu-item {{ request()->is(['karyawan', 'karyawan/*', 'divisi', 'unit', 'cuti', 'jamkerja', 'jabatan']) ? 'open' : '' }}">
                 ...
                 <ul class="menu-sub">
                     ...
                     @endcan
                     @can('unit.index')
                         <li class="menu-item {{ request()->is(['c', 'unit/*']) ? 'active' : '' }}">
         ...
         @endif
         @if (auth()->user()->hasAnyPermission(['harilibur.index', 'jamkerjabydiv.index', 'generalsetting.index']))
             <li
                 class="menu-item {{ request()->is(['harilibur', 'harilibur/*', 'jamkerjabydiv', 'jamkerjabydiv/*', 'generalsetting', 'denda']) ? 'open' : '' }}">
                 <a href="javascript:void(0);" class="menu-link menu-toggle">
                 ...
                 <ul class="menu-sub">
                     ...
                     <li class="menu-item {{ request()->is(['jamkerjabydiv', 'jamkerjabydiv/*']) ? 'active' : '' }}">
                         <a href="{{ route('jamkerjabydiv.index') }}" class="menu-link">
                             <div>Jam Kerja Divisi</div>
                         </a>
                     </li>
                 </ul>
             </li>
